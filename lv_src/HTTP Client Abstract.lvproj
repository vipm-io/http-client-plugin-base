...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="HTTP Client Advanced.lvclass" Type="LVClass" URL="../Classes/HTTP Client Advanced/HTTP Client Advanced.lvclass"/>
		<Item Name="HTTP Client Base.lvclass" Type="LVClass" URL="../Classes/HTTP Client Base/HTTP Client Base.lvclass"/>
		<Item Name="HTTP Client reqwest.lvclass" Type="LVClass" URL="../Classes/HTTP Client reqwest/HTTP Client reqwest.lvclass"/>
		<Item Name="reqwest.lvlib" Type="Library" URL="../../external/reqwest-rs-labview/lv_src/reqwest.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="lv_reqwest_64.dll" Type="Document" URL="../../external/reqwest-rs-labview/lv_src/lv_reqwest_64.dll"/>
		</Item>
